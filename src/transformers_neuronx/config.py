...
class QuantizationConfig:
    ...
    def __init__(self, **kargs):
        ...
        self.quant_dtype = kargs.pop('quant_dtype', 's8')
        ...
        self.dequant_dtype = kargs.pop('dequant_dtype', 'f16')

        # Which quantization algorithm to use
        self.quantize_method = kargs.pop('quantize_method', 'vector_dynamic')
        ...
        self.quantize_attn = kargs.pop('quantize_attn', True)
